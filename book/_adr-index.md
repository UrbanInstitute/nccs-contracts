...
| [0024](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0024-adhoc-data-requests-consumer-repo.md) | Ad-hoc Data Requests as a Thin Consumer Repo | Reconciled |
| [0025](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0025-requests-graduate-to-data-stories.md) | Ad-hoc Requests Graduate to Public Data Stories | Reconciled |
...
| [0032](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0032-ntee-cleaner-university-code-loss.md) | Correct NTEE Cleaning So `nteev2_subsector = UNI` Holds Actual Universities | Reconciled |
...
| [0036](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0036-ein-coercion-safety-additive-columns.md) | EIN Coercion-Safety via Additive Columns (`ein_prefixed` + `EIN2`; canonical `ein` unchanged) | Reconciled |
| [0037](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0037-master-bmf-rename-unified-supersession-provenance.md) | Master BMF → Unified BMF: Rename, Non-Silent Supersession, Per-Build Provenance | Reconciled |
...
| [0039](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0039-unified-bmf-geocoded-extension-rename.md) | Extend the Unified BMF Rename to the Geocoded Extension + State Marts | Reconciled |
| [0040](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0040-core-panel-parquet-canonical.md) | Promote core-panel to Parquet-Canonical (extends ADR 0027) | Accepted |
| [0041](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0041-legacy-street-recovery-address-resolved-crosswalk.md) | Recover Legacy Street Addresses; Re-geocode the Unified BMF; Address-Resolved Crosswalk | Reconciled |
| [0042](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0042-vintage-retention-latest-convention.md) | Vintage Retention + latest/ Convention for Rolling Artifacts; Address-History Table Shape; Docs Automation | Executing |
| [0043](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0043-legacy-format-compatibility-views.md) | Legacy-Format Compatibility Views + Plug-and-Play Mapping Tables | Accepted |
| [0044](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0044-legacy-zip-leading-zero-restoration.md) | Restore Legacy ZIP Leading Zeros; Gate Destructive Transforms | Proposed |
| [0045](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0045-census-geo-resolved-crosswalk.md) | Census-Geo-Resolved Crosswalk (per-EIN tract/block assignment) | Proposed |
...
| [0049](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0049-ntee-code-lookup-as-public-crosswalk.md) | The `ntee_code` lookup is the public NTEE-NAICS crosswalk: long descriptions, NAICS filled, website reads it | Accepted |
