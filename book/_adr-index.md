...
| [0050](https://github.com/UrbanInstitute/nccs-contracts/blob/main/decisions/0050-ein-index-for-self-service-lookup.md) | EIN index: sharded JSON so the website can look up one organization without a server | Proposed |
